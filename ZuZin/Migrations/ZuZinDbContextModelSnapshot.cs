...
{
    [DbContext(typeof(ZuZinDbContext))]
    partial class ZuZinDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZuZin.Models.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Email = "Thuyen2003@gmail.com",
                            Message = "Cà phê đen rất ngon nhá Shop",
                            Name = "Đinh Thuyền"
                        },
                        new
                        {
                            Id = 2,
                            Email = "Quyen2004@gmail.com",
                            Message = "MoCha thật sự rất tuyệt, cảm ơn Shop",
                            Name = "Phan Thị Thúy Quyên"
                        });
                });

            modelBuilder.Entity("ZuZin.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("ZuZin.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("ZuZin.Models.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            ProductId = 2,
                            Description = "Hương vị của Americano thường nhẹ nhàng hơn so với espresso đơn thuần, nhưng vẫn giữ được một phần của độ đậm và đắng của espresso.",
                            Image = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRZyQXS7p7D7joovsULkr-NbhfQIlvg94EQWA&usqp=CAU",
                            IsTrendingProduct = false,
                            Name = "Americano",
                            Price = 20m
                        },
                        ...
                        {
                            ProductId = 3,
                            Description = "Vị của Latte thường mềm mại, cân bằng giữa hương vị của espresso và sữa, có thể được tùy chỉnh theo sở thích cá nhân",
                            Image = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQAgQgtpjfcUCe9LG3w9qdTxmHGbuldlEKm4Q&usqp=CAU",
                            IsTrendingProduct = false,
                            Name = "Latte",
                            Price = 15m
                        },
                        ...
                        {
                            ProductId = 5,
                            Description = "Với hương vị ngọt ngào và thơm của sô-cô-la, Mocha thường được coi là một loại cà phê đáng ngưỡng mộ cho những người yêu thích hương vị đắng ngọt.",
                            Image = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQwjx5QNdVZ99iTvlU4dcMHeFsBqizbhuNDg&usqp=CAU",
                            IsTrendingProduct = false,
                            Name = "Cà phê Mocha",
                            Price = 25m
                        },
            ...
            modelBuilder.Entity("ZuZin.Models.ShoppingCartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ZuZin.Models.OrderDetail", b =>
                {
                    b.HasOne("ZuZin.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ZuZin.Models.Product", "Product")
                        .WithMany()
